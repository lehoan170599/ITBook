                        ...
                        @php
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$pro->product_cost}}" name="product_cost" class="form-control" id="exampleInputEmail1" placeholder="Giá gốc">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Giá bán</label>
                                    <input type="text" value="{{$pro->product_price}}" name="product_price" class="form-control" id="exampleInputEmail1" placeholder="Giá bán">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Số lượng</label>
                                    <input type="text" value="{{$pro->product_qty}}" name="product_qty" class="form-control" id="exampleInputEmail1" placeholder="Số lượng">
                                </div>
                                 <div class="form-group">
